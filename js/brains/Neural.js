...
var brains = [ [4, 0, new deepqlearn.Brain(inputs, numActions, opt)],
               [3, 1, new deepqlearn.Brain(inputs, numActions, opt)],
               [2, 2, new deepqlearn.Brain(inputs, numActions, opt)],
               [1, 3, new deepqlearn.Brain(inputs, numActions, opt)] ];
